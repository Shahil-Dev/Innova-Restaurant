...
const Login = () => {
    const { signin, google, githubSignIn } = useContext(AuthContext);
    ...
    const handleSocialLogin = async (provider) => {
        ...
        try {
            if (provider === 'google') {
                ...
                console.log(result.user); // optional: check if you get info
            }
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 overflow-hidden">
            <Helmet>
                <title>Innova Restaurant | Login</title>
            </Helmet>
            ...
            <section className="relative min-h-screen py-4 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
                <div className="container mx-auto max-w-7xl">
                    ...
                    >
                        ...
                        >
                            Welcome back to exceptional dining experiences
                        </motion.p>
                    </motion.div>
                                ...
                                <div className="p-6 sm:p-8 text-white">
                                    ...
                                    >
                                        {[
                                            ...
                                            "Resume your premium dining experience",
                                            "Access your special offers and rewards",
                                            "Dive back into our innovative cuisine"
                                        ][currentImage]}
                                    </motion.p>
                                </div>
                            </div>
                            ...
                            <div className="bg-gray-800/40 backdrop-blur-2xl rounded-3xl border border-white/10 shadow-2xl p-6 sm:p-8 lg:p-12">
                                ...
                                >
                                    ...
                                    <p className="text-amber-200/80 text-sm sm:text-base">
                                        Sign in to your Innova account
                                    </p>
                                </motion.div>
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                    ...
                                    <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
                                        <label className="flex items-center space-x-2 text-gray-300 cursor-pointer">
                                            <input type="checkbox" className="rounded border-gray-300 text-amber-500 focus:ring-amber-400" />
                                            <span className="text-sm">Remember me</span>
                                        </label>
                                        <Link to="/forgot-password" className="text-amber-400 hover:text-amber-300 text-sm transition-colors duration-200">
                                    ...
                                    <motion.button
                                        ...
                                        className={`w-full py-4 font-bold text-white rounded-2xl shadow-2xl transition-all duration-300 ${disabled || isLoading
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-1 gap-4 mt-6">
                                        ...
                                        <motion.button
                                            ...
                                            whileHover={{ scale: 1.05 }}
                                            whileTap={{ scale: 0.95 }}
                                            className="flex items-center justify-center px-4 py-3 space-x-3 bg-white/10 backdrop-blur-sm border border-white/10 rounded-2xl text-white hover:bg-white/20 transition-all duration-300 group disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
                                ...
                                >
                                    {["Instant Access", "Member Rewards", "Quick Booking", "Exclusive Deals"].map((feature) => (
                                        <motion.div
                                            key={feature}
                                            whileHover={{ scale: 1.05 }}
